...
- model: the specific vehicle model name or null if uncertain
  - color: the dominant exterior color or null if uncertain
  - viewType: the best matching angle from front, rear, side, angled, interior, or unknown
...
- Return null for brand/model if you are not confident.
  - If the view angle is clear, include it in viewType.
  - If the dominant exterior color is visible, include it in color.
...
- Return ONLY valid JSON, no markdown, no code fences.
  ...
  {\"isVehicle\":true,\"brand\":\"Toyota\",\"type\":\"SUV\",\"model\":\"Fortuner\",\"color\":\"White\",\"viewType\":\"front\",\"description\":\"A white midsize SUV with a tall stance and modern front styling.\"}`,
            },
            {
              type: "image_url",
              image_url: {
    ...
    try {
      ...
      if (!parsed.viewType) parsed.viewType = null;
