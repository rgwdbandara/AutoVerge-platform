...
function Articles() {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 transition-colors duration-300 dark:bg-[#020617] dark:text-white">
      ...
      <section className="relative overflow-hidden border-b border-slate-200 dark:border-white/10">
        ...
        <div className="absolute inset-0">
          ...
          <img
            ...
            alt=""
            className="object-cover w-full h-full opacity-100 dark:opacity-25"
          />
          ...
          <div className="absolute w-48 h-48 rounded-full left-10 top-10 bg-cyan-400/20 blur-3xl" />
          <div className="absolute bottom-0 right-0 rounded-full h-72 w-72 bg-blue-500/10 blur-3xl" />

        </div>

        {/* CONTENT */}
        <div className="relative px-6 pb-16 mx-auto max-w-7xl pt-28 lg:pb-20 lg:pt-32">

          <div className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold border rounded-full border-cyan-500/20 bg-cyan-500/10 text-cyan-600 dark:text-cyan-300">
            <Sparkles size={16} />
            {t("articles.badge", { defaultValue: "AutoVerge Articles" })}
          </div>

          <h1 className="max-w-5xl mt-6 text-5xl font-black leading-tight md:text-6xl lg:text-7xl">

            {t("articles.heroTitle", { defaultValue: "Latest Vehicle News, Reviews & AI Insights" })}

          </h1>

          <p className="max-w-3xl mt-6 text-lg leading-relaxed text-slate-600 dark:text-slate-300 md:text-xl">
          ...
          <div className="flex flex-wrap items-center gap-3 mt-8 text-sm text-slate-500 dark:text-slate-400">
            <span className="inline-flex items-center gap-2 px-4 py-2 border rounded-full border-slate-200 bg-white/80 dark:border-white/10 dark:bg-white/5">
      ...
      {error && (
        <section className="px-6 pt-4 mx-auto max-w-7xl">
      ...
      {/* FEATURED ARTICLE */}
      {loading ? (
        <section className="px-6 mx-auto -mt-6 max-w-7xl">
            ...
            <div className="group overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-xl transition duration-500 hover:-translate-y-1 hover:shadow-2xl dark:border-white/10 dark:bg-white/5 dark:backdrop-blur-xl">
              ...
              <div className="relative h-[340px] overflow-hidden">
                ...
                <div className="absolute left-6 top-6 flex items-center gap-2 rounded-full bg-cyan-500 px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-white shadow-lg shadow-cyan-500/20">
                  {t("articles.featuredStory", { defaultValue: "Featured Story" })}
                </div>

                <div className="absolute flex items-end justify-between gap-4 text-white bottom-6 left-6 right-6">
                  <div>
                  ...
                  <div className="hidden px-4 py-2 text-sm font-semibold rounded-full bg-white/10 backdrop-blur-md sm:inline-flex">
                    {t("articles.readLeadStory", { defaultValue: "Read the lead story" })}
                  </div>
                </div>
              ...
              <div className="p-8">
                ...
                >
                  ...
                  {t("articles.readFullArticle", { defaultValue: "Read Full Article" })}
                  <ArrowRight size={18} />
            ...
            <div className="space-y-6">
              <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-lg dark:border-white/10 dark:bg-white/5">
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-500">
                  {t("articles.freshPicks", { defaultValue: "Fresh Picks" })}
                </p>
                <h3 className="mt-3 text-2xl font-black text-slate-900 dark:text-white">
                  {t("articles.whatToReadNext", { defaultValue: "What to read next" })}
                </h3>
        ...
        <section className="px-6 mx-auto -mt-4 max-w-7xl">
      ...
      <section className="px-6 py-24 mx-auto max-w-7xl">
        ...
        <div className="flex flex-col gap-4 mb-14 md:flex-row md:items-end md:justify-between">
          ...
          <div className="px-4 py-2 text-sm bg-white border rounded-full border-slate-200 text-slate-600 dark:border-white/10 dark:bg-white/5 dark:text-slate-300">
